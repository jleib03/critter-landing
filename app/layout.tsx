...
export const metadata: Metadata = {
  metadataBase: new URL("https://critter.pet"),
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://critter.pet/images/critter-logo.png",
        width: 1200,
        height: 630,
        alt: "Critter - Automation Engine for Pet Care Businesses",
      },
    ],
  },
  twitter: {
    ...
    title: "Critter - Automation Engine for Growing Pet Care Businesses",
    description: "Turn insights into action with data-driven tools for CRM, marketing, and ongoing client engagement at scale.",
    images: ["https://critter.pet/images/critter-logo.png"],
  },
  icons: {
