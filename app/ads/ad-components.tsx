...
export const ads: Ad[] = [
  ...
  },
  {
    ...
    subHero: "Connect your pet care data to clearer insights and next steps.",
  ...
  },
  {
    id: "set-forget",
    layout: "centered",
    headline: "Thoughtful follow-ups.\nLess manual work.\nBuilt for pet care.",
    subHero: "Review your audience, copy, and timing. Then let your program follow the plan.",
    cta: "Set it up today",
