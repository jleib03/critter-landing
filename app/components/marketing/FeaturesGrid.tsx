...
const features = [
  ...
  { name: "Task Management", icon: ListChecks, href: "/features/crm" },
  { name: "Notifications Center", icon: Bell, href: "/features/crm" },
  ...
  { name: "Reporting Dashboards", icon: BarChart3, href: "/features/crm" },
  { name: "Website Chat Widget", icon: MessageCircle, href: "/pricing" },
  { name: "Multi-Location Support", icon: MapPin, href: "/pricing" },
